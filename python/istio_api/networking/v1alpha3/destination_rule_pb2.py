...
_CLIENTTLSSETTINGS_TLSPROTOCOL = _descriptor.EnumDescriptor(
  name='TLSProtocol',
  full_name='istio.networking.v1alpha3.ClientTLSSettings.TLSProtocol',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CLIENTTLSSETTINGS_TLSPROTOCOL)
...
_CLIENTTLSSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='ecdh_curves', full_name='istio.networking.v1alpha3.ClientTLSSettings.ecdh_curves', index=8,
      number=9, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='ecdhCurves', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls_minimum_protocol_version', full_name='istio.networking.v1alpha3.ClientTLSSettings.tls_minimum_protocol_version', index=9,
      number=10, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='tlsMinimumProtocolVersion', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls_maximum_protocol_version', full_name='istio.networking.v1alpha3.ClientTLSSettings.tls_maximum_protocol_version', index=10,
      number=11, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='tlsMaximumProtocolVersion', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
  enum_types=[
    ...
    _CLIENTTLSSETTINGS_TLSPROTOCOL,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_CLIENTTLSSETTINGS.fields_by_name['tls_minimum_protocol_version'].enum_type = _CLIENTTLSSETTINGS_TLSPROTOCOL
_CLIENTTLSSETTINGS.fields_by_name['tls_maximum_protocol_version'].enum_type = _CLIENTTLSSETTINGS_TLSPROTOCOL
_CLIENTTLSSETTINGS_TLSMODE.containing_type = _CLIENTTLSSETTINGS
_CLIENTTLSSETTINGS_TLSPROTOCOL.containing_type = _CLIENTTLSSETTINGS
