...
_SERVERTLSSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='ecdh_curves', full_name='istio.networking.v1alpha3.ServerTLSSettings.ecdh_curves', index=12,
