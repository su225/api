...
_MESHCONFIG_HTTP11PROTOCOLOPTIONS = _descriptor.Descriptor(
  name='Http11ProtocolOptions',
  full_name='istio.mesh.v1alpha1.MeshConfig.Http11ProtocolOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='preserve_header_key_casing', full_name='istio.mesh.v1alpha1.MeshConfig.Http11ProtocolOptions.preserve_header_key_casing', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_service_export_to', full_name='istio.mesh.v1alpha1.MeshConfig.default_service_export_to', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_virtual_service_export_to', full_name='istio.mesh.v1alpha1.MeshConfig.default_virtual_service_export_to', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_destination_rule_export_to', full_name='istio.mesh.v1alpha1.MeshConfig.default_destination_rule_export_to', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_namespace', full_name='istio.mesh.v1alpha1.MeshConfig.root_namespace', index=24,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dns_refresh_rate', full_name='istio.mesh.v1alpha1.MeshConfig.dns_refresh_rate', index=26,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='h2_upgrade_policy', full_name='istio.mesh.v1alpha1.MeshConfig.h2_upgrade_policy', index=27,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inbound_cluster_stat_name', full_name='istio.mesh.v1alpha1.MeshConfig.inbound_cluster_stat_name', index=28,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outbound_cluster_stat_name', full_name='istio.mesh.v1alpha1.MeshConfig.outbound_cluster_stat_name', index=29,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='certificates', full_name='istio.mesh.v1alpha1.MeshConfig.certificates', index=30,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='thrift_config', full_name='istio.mesh.v1alpha1.MeshConfig.thrift_config', index=31,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='service_settings', full_name='istio.mesh.v1alpha1.MeshConfig.service_settings', index=32,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_prometheus_merge', full_name='istio.mesh.v1alpha1.MeshConfig.enable_prometheus_merge', index=33,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='verify_certificate_at_client', full_name='istio.mesh.v1alpha1.MeshConfig.verify_certificate_at_client', index=34,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ca', full_name='istio.mesh.v1alpha1.MeshConfig.ca', index=35,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='extension_providers', full_name='istio.mesh.v1alpha1.MeshConfig.extension_providers', index=36,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http_11_protocol_options', full_name='istio.mesh.v1alpha1.MeshConfig.http_11_protocol_options', index=37,
  ...
  nested_types=[_MESHCONFIG_OUTBOUNDTRAFFICPOLICY, _MESHCONFIG_THRIFTCONFIG, _MESHCONFIG_SERVICESETTINGS, _MESHCONFIG_CA, _MESHCONFIG_EXTENSIONPROVIDER, _MESHCONFIG_HTTP11PROTOCOLOPTIONS, ],
  enum_types=[
...
_MESHCONFIG_HTTP11PROTOCOLOPTIONS.containing_type = _MESHCONFIG
...
_MESHCONFIG.fields_by_name['http_11_protocol_options'].message_type = _MESHCONFIG_HTTP11PROTOCOLOPTIONS
...
MeshConfig = _reflection.GeneratedProtocolMessageType('MeshConfig', (_message.Message,), {
  ...
  'Http11ProtocolOptions' : _reflection.GeneratedProtocolMessageType('Http11ProtocolOptions', (_message.Message,), {
    'DESCRIPTOR' : _MESHCONFIG_HTTP11PROTOCOLOPTIONS,
    '__module__' : 'mesh.v1alpha1.config_pb2'
    # @@protoc_insertion_point(class_scope:istio.mesh.v1alpha1.MeshConfig.Http11ProtocolOptions)
    })
  ,
...
_sym_db.RegisterMessage(MeshConfig.Http11ProtocolOptions)
