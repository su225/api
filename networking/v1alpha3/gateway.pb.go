...
type ServerTLSSettings struct {
	...
	// Optional: If specified, only use specified ECDH curves. Otherwise
	// default to the default curves supported by Envoy.
...
func (m *ServerTLSSettings) GetEcdhCurves() []string {
	if m != nil {
		return m.EcdhCurves
	}
	return nil
...
var fileDescriptor_067d98d02f84cc0b = []byte{
	...
	,
}
...
func (m *ServerTLSSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EcdhCurves) > 0 {
		for iNdEx := len(m.EcdhCurves) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintGateway(dAtA, i, uint64(len(m.EcdhCurves[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
